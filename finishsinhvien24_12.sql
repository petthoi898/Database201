...
END_YEAR INT
	...
	begin
        ...
        SELECT * FROM DIEM WHERE EXAMID = EXAM_ID AND STARTYEAR =START_YEAR AND ENDYEAR = END_YEAR AND TERM =TERM_;
    end //
DELIMITER ;
...
END_YEAR INT(11)
	...
	BEGIN
		SELECT * FROM DIEM WHERE TERM = TERM_ AND STARTYEAR =START_YEAR AND ENDYEAR =END_YEAR;
    END //
DELIMITER ;
# 3.7
